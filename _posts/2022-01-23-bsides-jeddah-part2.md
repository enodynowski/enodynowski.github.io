...
## <b> 12. The admin set a port forward rule to redirect the traffic from the public port to the WebLogic admin portal port. What is the public and WebLogic admin portal port number? </b> 
...
## <b> 13. The attacker gain access through WebLogic Server. What is the PID of the process responsible for the initial exploit? </b> 
...
## <b> 16. The attacker gain access to the system through the webserver. What is the CVE number of the vulnerability exploited? </b> 
...
## <b> 18. Multiple files were downloaded from the attacker’s web server. Provide the command used to download the Powershell script used for persistence? </b> 
...
## <b> 19. What is the MITRE ID related ot the persistence technique the attacker used?> </b> 
...
## <b> 20. WAfter maintaining persistence, the attacker dropped a cobalt strike beacon. Try to analyze and provide the Publickey_MD5.</b>  
...
## <b> 21. What is the URL of the exfiltrated data? </b> 
